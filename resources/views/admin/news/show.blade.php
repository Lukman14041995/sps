                ...
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <span
                                class="meta-badge {{ $news->status === 'published' ? 'meta-badge-success' : ($news->status === 'draft' ? 'meta-badge-warning' : 'meta-badge-secondary') }}">
                                <i
                                    class="fas fa-{{ $news->status === 'published' ? 'check-circle' : ($news->status === 'draft' ? 'edit' : 'archive') }} mr-2"></i>
                                {{ ucfirst($news->status) }}
                            </span>
                        </div>
                    ...
                    <div>
                        ...
                        @if ($news->thumbnail_image)
                            <div class="flex flex-col items-center">
                                <img src="{{ $news->thumbnail_url }}" alt="{{ $news->title }} Thumbnail"
                ...
                <div class="mb-8">
                    ...
                    <div class="seo-preview">
                        ...
                        <div class="description">
                            {{ $news->meta_description ?: $news->excerpt ?: 'No meta description provided' }}</div>
                    </div>
                    ...
                    <div class="timeline">
                        <div class="timeline-item">
                            ...
                            <div class="timeline-text">
                                ...
                                Article was created on {{ $news->created_at->format('F d, Y') }} at
                        ...
                        @if ($news->published_at)
                            <div class="timeline-item">
                                ...
                                <div class="timeline-text">
                                    ...
                                    Article was published on {{ $news->published_at->format('F d, Y') }} at
                ...
                slugElement.addEventListener('click', function() {
                    ...
                    navigator.clipboard.writeText(slugText).then(function() {
                        ...
                        slugElement.innerHTML =
                            '<i class="fas fa-check text-green-500 mr-1"></i> Copied!';
                        setTimeout(function() {
