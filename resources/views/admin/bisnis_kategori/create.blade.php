...
@section('title', 'Tambah Bisnis Kategori')
    ...
    <div class="w-full bg-gray-50 px-2 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm mb-4 px-3 sm:px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-lg sm:text-xl font-bold text-gray-900">Tambah Bisnis Kategori</h1>
                    <p class="text-gray-500 text-xs sm:text-sm">Tambahkan kategori bisnis baru</p>
                </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 sm:p-6 w-full">
            ...
            <form action="{{ route('admin.bisnis-kategori.store') }}" method="POST" class="space-y-5">
                @csrf
