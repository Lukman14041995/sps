                    ...
                    <nav class="mb-4">
                        <ol class="flex items-center space-x-2 text-white/80 text-sm">
                            ...
                            <li class="flex items-center">
                                ...
                                <a href="{{ route('frontend.csr.index') }}" class="hover:text-white transition-colors">CSR</a>
                            </li>
                            <li class="flex items-center">
                                <svg class="w-4 h-4 mx-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
        ...
        <div class="max-w-4xl mx-auto">
            <div class="grid lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mt-12">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            ...
                            <a href="{{ Storage::disk('s3')->url($image) }}" data-fancybox="gallery" class="block rounded-lg overflow-hidden group">
                ...
                <div class="space-y-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">{{ $categories[$csr->category]['name'] ?? $csr->category }}</p>
                                </div>
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="{{ route('frontend.csr.show', $related->slug) }}" class="group block">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-900 group-hover:text-blue-600 transition-colors">{{ Str::limit($related->title, 50) }}</h4>
                                        <p class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($related->created_at)->format('d M Y') }}</p>
                                    </div>
                                </div>
                            </a>
                            @endforeach
                    ...
                    <!-- Back to CSR -->
                    <a href="{{ route('frontend.csr.index') }}" class="block w-full py-3 bg-blue-600 text-white text-center font-medium rounded-lg hover:bg-blue-700 transition-colors">
