    ...
    <section class="relative bg-blue-900 pt-20"> <!-- Tambahkan pt-20 di sini -->
        <div class="relative h-[200px] sm:h-[250px] md:h-[300px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                <img src="{{ getNewsImageUrl($news->thumbnail_image) }}" class="w-full h-full object-cover"
                    alt="{{ $news->title }}" style="object-position: center 30%;" loading="lazy">
                <!-- Gradient Overlay -->
            ...
            <div class="relative h-full flex items-center justify-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center max-w-4xl mx-auto">
                        ...
                        <h1
                            class="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-4 leading-tight mt-4 sm:mt-0">
                            {{ $news->title }}
                        </h1>

                        <!-- Meta Info -->
                        <div
                            class="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-white/90 text-xs sm:text-sm md:text-base">
                            @if ($news->category)
                ...
                <div class="lg:flex lg:gap-8">
                    ...
                    <div class="lg:w-2/3">
                        ...
                        <article class="prose prose-lg max-w-none">
                            ...
                            <!-- Share Buttons -->
                            <div class="mt-8 sm:mt-10 pt-4 sm:pt-6 border-t border-gray-200">
                                <h4 class="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Bagikan Artikel
                                </h4>
                                ...
                                <div class="mt-8 sm:mt-10 bg-gray-50 rounded-lg sm:rounded-xl p-4 sm:p-6">
                                    <div class="flex items-start space-x-3 sm:space-x-4">
                                        <div class="flex-shrink-0">
                                            <div
                                                class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-full flex items-center justify-center">
                                                <i class="fas fa-user text-blue-600 text-sm sm:text-base"></i>
                                            </div>
                                        </div>
                                        <div>
                                            <h5 class="font-semibold text-gray-900 text-sm sm:text-base mb-1">Ditulis oleh
                                            </h5>
                                        ...
                                        <article
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="w-2/3 p-3 sm:p-4">
                                                    <h4
                                                        class="font-bold text-gray-900 text-sm sm:text-base mb-1 sm:mb-2 hover:text-blue-600 transition-colors">
                    ...
                    <div class="lg:w-1/3 mt-8 sm:mt-12 lg:mt-0">
                        ...
                        <div class="bg-gray-50 rounded-lg sm:rounded-xl p-4 sm:p-6">
                            ...
                            <div class="space-y-4 sm:space-y-6">
                                @foreach ($latestNews as $latest)
                                    <div
                                        class="flex items-start space-x-3 sm:space-x-4 pb-4 sm:pb-6 border-b border-gray-200 last:border-0">
                                        <div class="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16">
                                            <img src="{{ getNewsImageUrl($latest->thumbnail_image) }}"
                                                class="w-full h-full object-cover rounded-lg" alt="{{ $latest->title }}">
                                        </div>
                                        <div>
                                            <h5
                                                class="font-semibold text-gray-900 text-sm sm:text-base mb-1 hover:text-blue-600 transition-colors">
                        ...
                        <!-- Stats Widget -->
                        <div
                            class="mt-4 sm:mt-6 bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
                            ...
                            <div class="space-y-2 sm:space-y-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="font-semibold text-gray-900 text-sm sm:text-base">{{ number_format($news->views) }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600 text-sm sm:text-base">Likes</span>
                                    <span
                                        class="font-semibold text-gray-900 text-sm sm:text-base">{{ number_format($news->likes) }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600 text-sm sm:text-base">Shares</span>
                                    <span
                                        class="font-semibold text-gray-900 text-sm sm:text-base">{{ number_format($news->shares) }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600 text-sm sm:text-base">Reading Time</span>
                                    <span class="font-semibold text-gray-900 text-sm sm:text-base">{{ $readingTime }}
                                        min</span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function shareToTwitter() {
            window.open('https://twitter.com/intent/tweet?url=' + encodeURIComponent(window.location.href) + '&text=' +
                encodeURIComponent('{{ $news->title }}'), '_blank');
        }
